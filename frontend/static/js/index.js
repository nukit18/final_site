...
function render_boost(parent, boost){
  ...
  <div class="boost-holder" id="boost-holder">
    <input id="buy" type="image" class="boost _boost" src="../static/images/boost.png" onclick="buyBoost(${boost.level})" />
    <div class="boost_text">
    <div id="boostLevel"><span>Уровень апргрейда: ${boost.level}</span></div>
    <div id="boostPower"><span>Мощность: ${boost.power}</span></div>
    <div id="boostPrice"><span>Цена: ${boost.price} печенек</span></div>
    </div>
  </div>
  `
